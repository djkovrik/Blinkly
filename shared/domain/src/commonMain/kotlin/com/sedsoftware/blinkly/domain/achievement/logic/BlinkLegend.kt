...
/**
 * Achievement #29
 * Blink Legend - Perform 20000 blinks
 */
internal class BlinkLegend(
    private val blinkBreakCount: Int,
) : UnlockableAchievement {

    override val type: AchievementType = AchievementType.BLINK_LEGEND
    ...
    private companion object {
        const val ACHIEVEMENT_THRESHOLD = 20000
    }
}
