...
internal class TwoHundredExercisesTest : BaseAchievementTest() {

    override val achievement: UnlockableAchievement = TwoHundredExercises()

    @Test
    fun `when calendar and achievements match logic then unlocked`() = runTest {
        // given
        val calendar = FakeData.getCalendarWithFullAndPartialDays(now, 60)
        // when
